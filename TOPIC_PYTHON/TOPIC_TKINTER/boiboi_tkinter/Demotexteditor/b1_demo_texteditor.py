...
btn_open = tk.Button(frm_buttons, text="Open", fg="#71207E", bg="#D6E6F7", command=open_file)
btn_save = tk.Button(frm_buttons, text="save as...",fg="#71207E", bg="#D6E6F7", command=save_file)
